...
- (void)insertNewObject:(id)sender
{
    ...
    [newManagedObject setValue:@"kao" forKey:@"title"];
    // Save the context.
    NSError *error = nil;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (!self.detailViewController) {
        self.detailViewController = [[[SFDetailViewController alloc] initWithNibName:@"SFDetailViewController" bundle:nil] autorelease];
    }
...
- (NSFetchedResultsController *)fetchedResultsController
{
    ...
    NSSortDescriptor *sortDescriptor = [[[NSSortDescriptor alloc] initWithKey:@"creationDate" ascending:NO] autorelease];
...
- (void)configureCell:(UITableViewCell *)cell atIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.detailTextLabel.text = [[object valueForKey:@"creationDate"] description];
}
